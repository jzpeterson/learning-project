...
describe('Base64 decoder', () => {
    it('should decode a base64 string', async () => { // Make the function async
        // Given
        const base64String = 'SGVsbG8gV29ybGQ=';
        // When
        const decodedString = await decodeBase64String(base64String); // Await the promise
        // Then
    ...
    it('should get the params from the event', async () => {
        ...
        expect(params).toEqual({recipientPhoneNumber: "+18446151430", accountPhoneNumber: "+18017916516"});
    });
});
