...
export async function selectConversationsBetweenInternalAndExternalPhoneNumber(externalPhoneNumber: string,
                                                                               internalPhoneNumber: string) {
    console.log("Selecting active conversations between", externalPhoneNumber, "and", internalPhoneNumber)
    const conversations = await db
        .selectFrom("Conversation")
        .selectAll()
        .where("Conversation.account_phone_number", "=", internalPhoneNumber)
        .where("Conversation.recipient_phone_number", "=", externalPhoneNumber)
        .execute();
